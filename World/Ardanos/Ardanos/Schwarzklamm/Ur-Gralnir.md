...
Einmal im Jahrhundert findet hier das **Hammerfest** statt, bei dem alle Clanführer zusammentreffen, um Rat zu halten – begleitet von Ritualen, Waffensegnungen und Lesungen aus der **Chronik des Erzhammers**.

---

### 🧩 **Mögliche Rätsel & Geheimnisse**
...
- Der **Fluss fließt nicht bei jedem Besuch gleich** – in manchen Nächten ruht er, in anderen schlägt er gegen die Steine wie ein Herz im Zorn.

---
### **1. Hochpriester Thargrun Feuerzunge**

- **Rolle**: Oberster Runenpriester, Hüter des Ambosses
    
- **Beschreibung**: Alt, weise, mit kohlegrauem Bart, der in kupferne Ringe geflochten ist. Seine Stimme klingt wie rauer Stein. Trägt eine Schürze aus schwarzem Stahl.
    
- **Motivation**: Bewahrt uralte Lehren, skeptisch gegenüber Außenweltlern, spürt aber eine „Dunkelheit in der Tiefe“.
    
- **Plotfunktion**: Kann Visionen deuten, kennt vergessene Gebete und erkennt die Zeichen des Velgrim.
    

---

### **2. Balga Eisenruferin**

- **Rolle**: Schmiedemeisterin, Waffensegnerin der Pilger
...
### **3. Glomdir Schwarzglanz**

- **Rolle**: Wächter des inneren Quellraums
    
- **Beschreibung**: Schweigsam, bullig, mit Narben, die vom Kampf gegen etwas stammen, das er nicht benennt.
    
- **Motivation**: Verteidigt das Allerheiligste – aber sein Glaube wankt, da er kürzlich etwas im Wasser „gesehen“ hat, das nicht hätte sein dürfen.
    
- **Plotfunktion**: Ist innerlich zerrissen – als Verbündeter oder Hindernis nutzbar, je nach Verhalten der Gruppe.
...
- **Rolle**: Junger Novize und Chronist
    
- **Beschreibung**: Begeistert von alten Schriften, träumt von Abenteuern. Schreibt ständig mit.
    
- **Motivation**: Will „die Geschichte neu schreiben“ – glaubt, dass etwas mit Ur-Gralnir nicht stimmt.
    
- **Plotfunktion**: Hat möglicherweise versehentlich ein uraltes Ritual aktiviert oder Hinweise auf eine Verschwörung entdeckt.