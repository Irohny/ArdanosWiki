...
hit_die = (
    10
    if char_class in ["Kämpfer", "Paladin", "Waldläufer"]
    else (
        12
        if char_class == "Barbar"
        else 6 if char_class in ["Magier", "Zauberer"] else 8
    )
)
...
traits = st.text_area(
    "Traits & Features", value="Tapferkeit, Dunkelsicht, Zweihandwaffen"
)
